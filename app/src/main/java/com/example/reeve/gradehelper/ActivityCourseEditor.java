package com.example.reeve.gradehelper;
...
import static com.example.reeve.gradehelper.ActivityMain.SHARED_PREFS;
    ...
    private void onRemoveClick(){
        removeBut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(!course.getGradeTypes().isEmpty()) {
                    course.getGradeTypes().remove(0);
                    saveData();
